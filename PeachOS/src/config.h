...
#define PEACHOS_USER_PROGRAM_STACK_SIZE					1024 * 16 // 16 kB
#define PEACHOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START		0x3FF000
#define PEACHOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END		PEACHOS_VIRTUAL_STACK_ADDRESS_START - PEACHOS_USER_PROGRAM_STACK_SIZE
